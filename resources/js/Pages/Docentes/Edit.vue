<template>
    ...
    <AuthenticatedLayout>
        ...
        <div  class="mt-1 mb-1 grid justify-items-end p-1 border-b border-gray-200 ">
            <Link v-if="$page.props.auth.user.tipo === 2" :href="route('docentes.index')" 
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200">
               <form @submit.prevent="$event => form.patch(route('docentes.update', docente))" >
...
const form = useForm({
    cedula: props.docente.cedula,
    nombre: props.docente.nombre,
    sexo: props.docente.sexo,
    direc_hab: props.docente.direc_hab,
    edo_hab: props.docente.edo_hab,
    ciud_hab: props.docente.ciud_hab,
